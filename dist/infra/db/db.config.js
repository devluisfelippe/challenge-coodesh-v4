...
exports.databaseConnected = exports.db = void 0;
...
const mongoClient = new mongodb_1.MongoClient('mongodb+srv://admin:admin@api-challenger-coodesh.zessy.mongodb.net/?retryWrites=true&w=majority&appName=api-challenger-coodesh');
...
exports.databaseConnected = databaseConnected;
dbConnect();
